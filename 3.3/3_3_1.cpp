...
int main(){
	...
	DimondCompany D(int comp_id, string name, int staff_qnty, double revenue, int import_qnty,
	 int export_qnty, string ceo );
		
	for(i=0;i<n;i++){
		int id; string name; int staff_qnty; double revenue; int import_qnty;
	 int export_qnty; string ceo;
		cout<<"Company Id :";
		cin>>id;
		cout<<"Company Name :";
	...
	for(int i=0; i<n;i++){
//		D[i].displayCompInfo(int comp_id,
//		string comp_name,
//		int comp_staff_quantity,
//		double comp_revenue,
//		int comp_import_raw_diamonds ,
//		int comp_export_diamonds ,
//		string comp_ceo);
//D[i].displayCompInfo(comp_id,
//                    comp_name,
//                    comp_staff_quantity,
//                    comp_revenue,
//                    comp_import_raw_diamonds,
//                    comp_export_diamonds,
//                    comp_ceo);
D.displayCompInfo();
	}
	return 0;
